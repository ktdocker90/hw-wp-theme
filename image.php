...
<?php do_action('hw_before_main_content'); ?>
	...
	?>
			...
			<nav id="image-navigation" class="navigation image-navigation">
				<div class="nav-links">
				<?php previous_image_link( false, '<div class="previous-image">' . __( 'Previous Image', 'my-theme' ) . '</div>' ); ?>
				<?php next_image_link( false, '<div class="next-image">' . __( 'Next Image', 'my-theme' ) . '</div>' ); ?>
				</div><!-- .nav-links -->
