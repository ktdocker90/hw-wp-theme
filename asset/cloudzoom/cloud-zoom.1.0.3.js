        ...
        this.each(function () {
            ...
            if ($(this).is('.cloud-zoom')) {
                ...
                $(this).bind('click', $(this), function (event) {
					...
					//console.log('#' + data.useZoom + ' img',event.data.data('relOpts').smallImage);
					//by hoang
					//if($.inArray(this, thumbs)===-1) thumbs.push(this);
					if(!thumbs[event.data.attr('href')]) {
						thumbs[event.data.attr('href')] = this;
					}
					for(var i in thumbs) $(thumbs[i]).removeClass('cloud-zoom-active');
					$(this).addClass('cloud-zoom-active');
					//end
					console.log(Object.keys(thumbs).length);
